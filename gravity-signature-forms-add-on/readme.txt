...
2. [WP E-Signature](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) (Elite or Lifetime license)
3. [Stand Alone Document](https://www.approveme.com/wpesign-features/stand-alone-documents/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) (comes with above licenses)

*A Elite or Lifetime license is required and can be purchased at [www.approveme.com](http://aprv.me/2lOpn7l)
...
**The new signature add-on by [Approve Me](http://www.secure.approveme.com/demo/gravity-forms-demo/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) is the bridge between a form generation plugin and having a UETA / ESIGN compliant document signing application that lives on your WordPress website.**
...
**Signature Add-On for Gravity Forms by [Approve Me](http://www.secure.approveme.com/demo/gravity-forms-demo/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) allows you to capture court recognized signatures immediately after a user submits a Gravity Form by either emailing or redirecting the users that recently filled out your gravityform to a unique contract or agreement made specific for that user, requiring them to draw (or type) their electronic signature using a touchscreen device, touch pads or even a mouse.**

*With [WP E-Signature](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) (Elite or Lifetime) and this Digital Signature for GravityForms plugin you can automatically generate a contract for your customers to sign based on their form results from a Gravity Forms.*
...
WP E-Signature has a very extensive e-signature premium add-on library with dozens of expandable and customizable [e-signature automations](https://www.approveme.com/wpesign-features/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) and [third-party integrations](https://www.approveme.com/esign-features/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) to further enhance your custom document signing needs.
...
**Connect Gravity Forms With Wp E-Signature**This Signature Add-On for Gravity Forms will combine the powerful features of gravity forms with the relentless fury of features from WP E-Signature.

**Add Gravity Form Field Values Into A Wp E-Signature Contract**With Signature Add-On for Gravity Forms you can easily insert submitted form results into a contract that gets triggered automatically once a user completes a Gravity Form submission.
...
Documents move turbo speed from signer to signer. We include a detailed audit report with viewer details, ip addresses, analytics and signer history. [See how the audit trail can protect you and your signers](https://www.approveme.com/wordpress-audit-trail-e-signature-certificate/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)
...
WP E-Signature works with any WordPress website, including the default WordPress themes. If you need help installing WordPress E-Signature check out our [getting started docs](https://wpe.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) and start signing documents using your WordPress website.  Looking to get WordPress Proposals signed?  We got you covered!

If you're looking for a tailored WordPress eSigning integration or add-on designed specifically to be used for your document signing needs be sure to browse the official [WP E-Signature Business Add-On Extensions](https://www.approveme.com/wpesign-features/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) which come with an Lifetime or Elite license.   If you don’t see the integrations you need… let us know.
...
Whether you're operating a wedding photography business a membership based website, or a just a small web design agency in need of clients signing your website terms of service WP E-Signature has you covered. You can read all about ‘WP E-Signature’ features on the [ApproveMe website](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms).

= Customizable =
Your business is unique, your online document signing process should be too. Choose from many of our [e-signature workflows](https://www.approveme.com/wpesign-features/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) best of all e-signature is hosted using your WordPress website.

= Tablet & Smart Phone Friendly = 
Upload documents via WordPress dashboard and collect real client signatures through your website using ApproveMe’s [Wordpress Contract Plugin](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms). Users sign documents online using their mouse, trackpad, tablet, or phone.
...
To create a support ticket please login to your account [www.approveme.com/support](https://www.approveme.com/sign-in/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) and we look forward to helping you resolve your issue.

If you have any other non-support related questions about ApproveMe’s WP E-Signature you’re welcome to ask any pre-sale questions from our [contact form page](https://www.approveme.com/letschat/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms).

Free ebook:
[7 Ways to Protect Your Company from Contracts That Aren’t Binding](https://www.approveme.com/free-ebook-digital-e-signature-is-it-legal/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)

To view a live Gravity to WP E-Signature demo you can check one out at:

**[Try Gravity Forms + WP E-Signature Demo Here](http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)**
...
Learn more about the WP E-Signature document security here: (https://www.approveme.com/security-ueta-e-sign-protection/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)

Free ebook:
[7 Ways to Protect Your Company from Contracts That Aren’t Binding](https://www.approveme.com/free-ebook-digital-e-signature-is-it-legal/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)

*A valid WP E-Signature business license is required for this Gravity Forms Signature plugin to work.  You can easily purchase yours at (https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)*
...
1. [Gravity Forms](http://aprv.me/1TAspLi)
2. [WP E-Signature](http://aprv.me/2lfrDYG) (Elite or Lifetime license)
3. [Stand Alone Document](http://aprv.me/2lfrDYG) (comes with above licenses)

*A Lifetime or Elite license is required and can be purchased at [www.approveme.com](https://www.approveme.com/gravity-forms-special-pricing/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)
...
To download your license key you can log into your [ApproveMe account](https://www.approveme.com/purchase-history?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) here (password was emailed with your receipt)
...
To learn about Stand Alone Documents you can visit this [helpful article](https://wpe.approveme.com/article/156-basic-document-vs-stand-alone-document?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)
...
To learn more about Stand Alone Documents checkout the [documentation page](https://wpe.approveme.com/article/137-stand-alone-documents-add-on?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) for this add-on.
...
To insert data into a Gravity Form, you will need the [Custom Fields](https://www.approveme.com/wpesign-features/signer-input-fields/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) feature enabled by ApproveMe (it’s included with your license).
...
To view a live Gravity to WP E-Signature demo you can check one out at:
**[Try Gravity Forms Signature Demo Here](http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)**
...
*A valid [Elite or Lifetime](https://www.approveme.com/gravity-forms-special-pricing/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) is required for Gravity Forms Signature plugin by ApproveMe to properly work*

**[Get Your ApproveMe License Now](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)**
...
With Signature Add-on for Gravity Forms  by ApproveMe, along with a [WP E-Signature](https://www.approveme.com/gravity-forms-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) Lifetime or Elite license you can easily collect [UETA/ESIGN compliant](https://www.approveme.com/ueta-and-esign-act/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms) signatures from your visitors after they submit a Gravity Form on your website.
...
Yes you will (unless you have a Lifetime License). Each license key is valid for one calendar year from the purchase date. An active license key is needed for access to automatic/critical updates, plugin support and access to our growing [e-signature add-on library](https://www.approveme.com/esign-features/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms).

= Where Can I Find My License Key? =

If you’ve already purchased a license key and need to retrieve the license number, you can do that on the [support site here](https://www.approveme.com/profile/) or follow [these detailed steps](https://wpe.approveme.com/article/141-install-and-activate-plugins-extensions?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms). Once you’ve successfully logged into the support site (using the credentials emailed to you at the time of purchase), your active license key(s) will be listed at the bottom of the page.
...
8. **Define Your Signing Logic:** This is the page (inside of Gravity Forms) that needs to be customized.  Please choose the Signers Full Name and the Signers Email address along with any other additional/advanced e-signature settings you’d like for your contract.
9. **User Submits a Gravity Form** Once a user submits the Gravity Form that you connected to your WP e-signature contract they will either be redirected to the contract immediately or emailed a invitation to signer their specific/custom contract that includes details from the submitted Gravity Form.
...
15. **WordPress Audit Trail e-signature Certificate:** Proving signer intent is a very important component to signing electronic documents.  Every contract that is signed using WP E-Signature includes a detailed Signature Certificate.  You can [read all about the security of this report here](https://www.approveme.com/wordpress-audit-trail-e-signature-certificate/). 

**[Try a demo of the Signature Add-on for Gravity Forms Here](http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=gravity-forms)**

== Changelog ==
Version 2.0.5
FIX: Wrong invite marked signed when document has multiple invitations, causing post-sign redirect to fail.
...
Version 2.0.2
FIX: Fix Code/Text mode field insertion crash in document editor
FIX: Fix GF bridge fields blank when viewing signed document via email link
...
Version 1.8.5
FIX: Private page selection issue . 
FIX: Some minor bugs
...
Version 1.5.5.3 - January 14, 2020
