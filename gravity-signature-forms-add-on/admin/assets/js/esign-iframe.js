...
var elements = document.getElementsByClassName("notice");
for (var i = 0; i < elements.length; i++) {
   elements[i].remove();
}

var elements = document.getElementsByClassName("error_notice_ff_fluentform_pro_license");
for (var i = 0; i < elements.length; i++) {
   elements[i].remove();
}
