<input type="hidden" id="gravity-feedback-url" value="<?php echo esc_attr($data['feedback_url'])?>">
<input type="hidden" id="gravity-rating-url" value="<?php echo esc_attr($data['plugin_url'])?>">
<input type="hidden" id="gravity-plugin-name" value="<?php echo esc_attr($data['form_name'])?>">
