...
function esig_generate_about_page(array $about_options = array())
{
    ...
    if (!array_key_exists('main-cta', $about_options)) {
        $about_options['main-cta'] = 'https://www.approveme.com/' . $about_options['plugin-slug'] . '-signature-special/?utm_source=wprepo&utm_medium=link&utm_campaign=' . esc_attr($about_options['plugin-slug']);
    }
                            ...
                            ?>
                                ...
                                ?>
                                    <p>
                                        ...
                                        Meet WP E-Signature, an easy-to-use, reliable WordPress plugin that gives you the eSignature & Gravity Forms automation tools you need to protect your business (while saving you a ton of money and time).
                                    </p>
